	            ...
	            <form method = "POST" action = "../php/UpdateProperty.php">
                    ...
                    <table align="center" width="97%">
                        ...
                        <tr>
                            ...
                            <td style="padding-top: 20px;">
                                <input type="text" id="propertySqrFt" name="propertySqrFt" class="input" tabindex="10" required>
                            </td>
                        </tr>
                        <tr>
                            <td class="text">
                            ...
                            <td><select name="propertyType" id="propertyType" class="input" tabindex="2" required></select>  
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" id="propertyAddress1" name="propertyAddress1" class="input" tabindex="3" required>
                            </td> 
                            <td></td>
                            <td class="text">
                                Total Bath
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" id="propertyParking" name="propertyParking" class="input" tabindex="13" required>
                            </td>
                        </tr>
                        <tr>
	                        <td class="text">
                        ...
                        <tr>
	                       <td class="text">
                            ...
                            <td>
                                <input type="text" id="propertyCity" name="propertyCity" class="input" tabindex="5" disabled required>
                            </td>
                            <td></td>
                            <td class="text">
                                Lease Period
                        ...
                        <tr>
                            ...
                            <td valign="top">
                                <input type="text" id="propertyPrice" name="propertyPrice" class="input" tabindex="9" required onkeypress="return isNumberWithDecimal(event)">
                            </td>
                            <td></td>
                        </tr>
