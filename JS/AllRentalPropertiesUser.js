function getPropertiesUser(stateId) {
    ...
    xmlhttp.onreadystatechange = function() {
        ...
        if (this.readyState == 4 && this.status == 200) {
            ...
            if (xmlhttp.responseText.includes("NAME")){
               ...
               document.getElementById("noData").innerHTML="Sorry! No Property found";
            }
        }
    };
    if (stateId == 0) {
        ...
        xmlhttp.open("GET", "../php/GetAvailablePropertiesStateWise.php?state="+stateId, true);
    }
    xmlhttp.send();
}
...
function getstates()
{
    ...
    xmlhttp.onreadystatechange = function() 
    {
        if (this.readyState == 4 && this.status == 200) 
        {
            ...
            function propertyState(state)
            {
                var state_id = state['StateId'];
                var state_name = state['StateName'];
